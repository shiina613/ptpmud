...
public class TaiKhoanDAO extends DAVISY<TaiKhoanEntity, String> {
    ...
    public void updateMyAccount(TaiKhoanEntity entity) {
        JdbcHelper.update(UPDATE_SQL, entity.getMaCV(), entity.getTenNV(), entity.getEmail(), entity.getMatKhau(), entity.getDiaChi(), entity.getDienThoai(), entity.getNgaySinh(), entity.isGioiTInh(), true, entity.getTenDN());
    }

     public void updateMyAccout(TaiKhoanEntity entity) {
        JdbcHelper.update(UPDATE_SQL, entity.getMaCV(), entity.getTenNV(), entity.getEmail(), entity.getMatKhau(), entity.getDiaChi(), entity.getDienThoai(), entity.getNgaySinh(), entity.isGioiTInh(), entity.isTrangThai(), entity.getTenDN());
    }
