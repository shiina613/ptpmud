...
public class SendQR {
    ...
    public String sendcode(String email) throws IOException {
        ...
        final String username = "hoahuongduong05124@gmail.com";
        final String password = "ytotxwzbrwkoddjd";//"ngemudntvdmhwwju"
        ...
        try {
            ...
            message.setSubject("Xác nhận thay đổi mật khẩu trên hệ thống ");
